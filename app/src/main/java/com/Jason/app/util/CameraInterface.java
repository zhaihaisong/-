...
import static com.Jason.app.util.CameraParaUtil.CAMERA_FILE_PATH;
import static com.Jason.app.util.CameraParaUtil.VIDEO_FILE_PATH;
...
public class CameraInterface {
    ...
    private int mCameraId = Camera.CameraInfo.CAMERA_FACING_FRONT; //前置或后置摄像头
...
//        params.set("rotation", 90);//照片旋转90度
        ...
        CameraParaUtil.getInstance().printSupportPictureSize(params);
       CameraParaUtil.getInstance().printSupportPreviewSize(params);
        //设置PreviewSize和PictureSize
        Camera.Size pictureSize =CameraParaUtil.getInstance().getPropPictureSize(params.getSupportedPictureSizes(), viewRate, minPicWidth);
        Camera.Size previewSize =CameraParaUtil.getInstance().getPropPreviewSize(params.getSupportedPreviewSizes(), previewRate, minPreViewWidth);
...
//                SydCameraActivity.this.sendBroadcast(localIntent);
            } else {
